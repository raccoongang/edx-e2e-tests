...
class TestCourseEnrollment(WebAppTest):
    ...
    def test_course_enrollment(self):
        ...
        if self.course_about_page.enroll_button.text.lower() == u'enroll' or \
            self.course_about_page.enroll_button.text.lower() == 'enroll in demox':
            self.course_about_page.enroll_button.click()
            self.dashboard_page.wait_for_page()
            self.dashboard_page.is_browser_on_page()
        elif self.course_about_page.enroll_button.text.lower() == u'view Course' or \
                u'you are enrolled in this course':
