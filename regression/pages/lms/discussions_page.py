...
class DiscussionsHomePageExtended(DiscussionTabHomePage):
    ...
    def is_browser_on_page(self):
        return self.q(css=".discussion.discussion-board.page-content-container").present
    ...
    def fill_post_form(self, title_text, question_text):
        ...
        self.scroll_to_element('.btn.btn-primary.submit')
        self.q(css='.btn.btn-primary.submit').click()
